/*
 * xorgateblock.cpp: Implementation of xorgateblock.h
 *
 ...
 * */
#include "xorgateblock.h"

XorGateBlock::XorGateBlock(ComponentArea *parent, QPoint location, QColor color, bool positionLocked) :
    XorGateBlock(parent, getNewBlockModel(parent, location, color, positionLocked))
{

}

XorGateBlock::XorGateBlock(ComponentArea *parent, BlockModel blockModel) :
...
XorGateBlock::XorGateBlock()
{
}

XorGateBlock* XorGateBlock::getVirtualInstance()
{
    return new XorGateBlock();
}

void XorGateBlock::drawBlockOnGivenPainter(QPainter *painter, bool paintHoverOutlines, bool selected)
{
...
QSize XorGateBlock::defaultSize()
{
    return QSize(45, 42);
}

void XorGateBlock::produceOutputValues()
{
...
QString XorGateBlock::getParameters()
{
    return "";
}

void XorGateBlock::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
BlockModel XorGateBlock::getNewBlockModel(ComponentArea *parent, QPoint location, QColor color, bool positionLocked)
{
    BlockModel blockModel = BlockModel();
    blockModel.blockType = AbstractBlock::XORGATE;
